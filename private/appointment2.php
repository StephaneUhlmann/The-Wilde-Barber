<!--This page books an appointment taking as a option the barber's location-->
...
<div class="container">
<!-- this page books an appointment by the barbers location-->
<h2>Book an appointment</h2>
<form method="POST" action="appointment_next.php">
  <div class="form-group">
    <label for="exampleFormControlSelect1">Select a Location</label>
    <select name= "Barber" class="form-control" id="exampleFormControlSelect1">
    <?php foreach ($db->query($sql) as $row) { /*loop the first database query and display a list of addresses showing the number, street and city*/
      echo "<option>".$row['number'] . "&nbsp;" . $row['street']. ",&nbsp;" . $row['City']."</option>";
  }
      ?>
